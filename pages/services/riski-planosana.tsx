// pages/services/riski-planosana.tsx
import Head from "next/head";
import Link from "next/link";

export default function RiskiPlanosanaPage() {
    ...
    <>
      ...
      <main className="mx-auto max-w-5xl px-6 py-12">
        ...
        <div className="mt-12 rounded-2xl border border-neutral-200 p-6">
          <h3 className="text-lg font-medium text-neutral-900">Vēlies risku karti un plānu savam biznesam?</h3>
